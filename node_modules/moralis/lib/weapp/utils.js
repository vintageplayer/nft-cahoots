...
var isSemanticVersionLarger = function (version1, version2) {
  ...
  var version1Arr = (0, _map.default)(_context7 = version1.split('.')).call(_context7, function (s) {
    return Number(s);
  });
  var version2Arr = (0, _map.default)(_context8 = version2.split('.')).call(_context8, function (s) {
    return Number(s);
  });
    ...
    return _regenerator.default.wrap(function (_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 3:
            _yield$RESTController2 = _context9.sent;
            response = _yield$RESTController2.response;
            latestVersion = response.version;
            installedVersion = "0.0.154";
